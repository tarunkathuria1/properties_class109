...
#Mean of heigth and weight
height_mean = statistics.mean(height_list)
weight_mean = statistics .mean(weight_list)
#Median of hight and weigth
height_median = statistics.median(height_list)
weight_median = statistics.median(weight_list)
#Mode of height and weight
height_mode = statistics.mode(height_list)
weight_mode = statistics.mode(weight_list)
#print mean,median,modeto validate
print("Mean, Median,Mode of height is {},{}and{} respectively".format(height_mean,height_median,height_mode))
print("Mean, Median,Mode of height is {},{}and{} respectively".format(weight_mean,weight_median,weight_mode))
